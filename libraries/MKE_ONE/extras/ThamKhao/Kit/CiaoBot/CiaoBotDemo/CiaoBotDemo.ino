...
#include "MKE_DFRobotDFPlayerMini.h"
...
MKE_LiquidCrystal_I2C lcd(0x27, 16, 2);     //Declare a lcd object which I2C address is 0x27, 16 columns, and 2 rows
MKE_DFRobotDFPlayerMini myDFPlayer;         //Declare DFPlayerMini object
